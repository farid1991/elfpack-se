...
{
  if ( LoadConfigData( GetDir( DIR_ELFS_CONFIG|MEM_EXTERNAL ), L"CameraLenscover.bcfg" ) < 0 )
  {
    LoadConfigData( GetDir( DIR_ELFS_CONFIG|MEM_INTERNAL ), L"CameraLenscover.bcfg" );
  }
}
