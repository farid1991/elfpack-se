...
void _merge_from_v2_7(v2_8_config_t *newcfg, v2_7_config_t *oldcfg)
{
//Картинки ...
//Картинка 1
...
int merge_from_v2_7(v2_8_config_t *newcfg, void *oldcfg, int oldcfgsize)
{
  int result = -1;
  if(oldcfgsize == sizeof(v2_7_config_t))
  {
    _merge_from_v2_7(newcfg, (v2_7_config_t *)oldcfg);
    result = 0;
  }
  return(result);
}
