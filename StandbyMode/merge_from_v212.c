...
void _merge_from_v2_12(v2_13_config_t *newcfg, v2_12_config_t *oldcfg)
{
//Картинки ...
//Картинка 1
...
//Иконки статуса...
  ...
  newcfg->cfg_status_phf_show = 1;
  newcfg->cfg_status_chf_show = 1;
  newcfg->cfg_status_internet_show = 1;
...
#define STATUS_ICN_CFG_D_NEW(num, file) \
  ...
  STATUS_ICN_CFG_D_NEW(20, L"headset.png");
  STATUS_ICN_CFG_D_NEW(21, L"handsfree.png");
  STATUS_ICN_CFG_D_NEW(22, L"internet.png");
...
int merge_from_v2_12(v2_13_config_t *newcfg, void *oldcfg, int oldcfgsize)
{
  int result = -1;
  if(oldcfgsize == sizeof(v2_12_config_t))
  {
    _merge_from_v2_12(newcfg, (v2_12_config_t *)oldcfg);
    result = 0;
  }
  else
  {
    char *buf;
    if ((buf=new char[sizeof(v2_12_config_t)]))
    {
      if(merge_from_v2_11((v2_12_config_t *)buf, oldcfg, oldcfgsize) == 0)
      {
        _merge_from_v2_12(newcfg, (v2_12_config_t *)buf);
        result = 0;
      }
    }
    delete buf;
