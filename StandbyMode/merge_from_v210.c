...
void _merge_from_v2_10(v2_11_config_t *newcfg, v2_10_config_t *oldcfg)
{
//Картинки ...
//Картинка 1
...
//Время 2...
  ...
  newcfg->cfg_clock2_nonstandby_show = 1;
...
//Иконки статуса...
  newcfg->cfg_status_not_show_if_player = 0;
//Сеть...
...
//Иконки статуса...
  newcfg->cfg_status_show = 0;
  newcfg->cfg_orig_status_show = 1;
  newcfg->cfg_status_row_max = 1;
  newcfg->cfg_status_column_max = 8;
  newcfg->cfg_status_fill_by_row = 0;
  newcfg->cfg_status_x = 0;
  newcfg->cfg_status_y = 0;
  newcfg->cfg_status_refresh = 2000;
  newcfg->cfg_status_silent_show = 1;
  newcfg->cfg_status_lock_show = 1;
  newcfg->cfg_status_missed_show = 1;
  newcfg->cfg_status_media_show = 1;
  newcfg->cfg_status_java_show = 1;
  newcfg->cfg_status_profile_show = 1;
  newcfg->cfg_status_bluetooth_show = 1;
  newcfg->cfg_status_usb_show = 1;

#define STATUS_ICN_CFG_D(num, file) \
  ...
  STATUS_ICN_CFG_D(0, L"lock.png");
  STATUS_ICN_CFG_D(1, L"silent.png");
  STATUS_ICN_CFG_D(2, L"mediaplayer.png");
  STATUS_ICN_CFG_D(3, L"fmradio.png");
  STATUS_ICN_CFG_D(4, L"video.png");
  STATUS_ICN_CFG_D(5, L"java.png");
  STATUS_ICN_CFG_D(6, L"missed_calls.png");
  STATUS_ICN_CFG_D(7, L"missed_sms.png");
  STATUS_ICN_CFG_D(8, L"missed_mms.png");
  STATUS_ICN_CFG_D(9, L"missed_email.png");
  STATUS_ICN_CFG_D(10, L"pr_meeting.png");
  STATUS_ICN_CFG_D(11, L"pr_incar.png");
  STATUS_ICN_CFG_D(12, L"pr_outdoors.png");
  STATUS_ICN_CFG_D(13, L"pr_phf.png");
  STATUS_ICN_CFG_D(14, L"pr_home.png");
  STATUS_ICN_CFG_D(15, L"pr_office.png");
  STATUS_ICN_CFG_D(16, L"bt_visible.png");
  STATUS_ICN_CFG_D(17, L"bt_unvisible.png");
  STATUS_ICN_CFG_D(18, L"bt_active.png");
  STATUS_ICN_CFG_D(19, L"usb.png");
...
{
  int result = -1;
  if(oldcfgsize == sizeof(v2_10_config_t))
  {
    _merge_from_v2_10(newcfg, (v2_10_config_t *)oldcfg);
    result = 0;
  }
  else
  {
    char *buf;
    if ((buf=new char[sizeof(v2_10_config_t)]))
    {
      if(merge_from_v2_9((v2_10_config_t *)buf, oldcfg, oldcfgsize) == 0)
      {
        _merge_from_v2_10(newcfg, (v2_10_config_t *)buf);
        result = 0;
      }
    }
    delete buf;
