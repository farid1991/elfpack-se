...
void _merge_from_v2_14(v2_15_config_t *newcfg, v2_14_config_t *oldcfg)
{
//Картинки ...
//Картинка 1
...
//День...
  ...
  newcfg->cfg_alarm_image_show = 0;
  newcfg->cfg_alarm_image_x = 0;
  newcfg->cfg_alarm_image_y = 0;
  wstrcpy(newcfg->cfg_alarm_image_file, L"%INI_INT%/Standby Mode/alarm_image.png");
...
//Иконки статуса...
  ...
  newcfg->cfg_status_irda_show = 1;
  newcfg->cfg_status_stopwatch_show = 1;
...
#define STATUS_ICN_CFG_D_NEW(num, file) \
  ...
  STATUS_ICN_CFG_D_NEW(24, L"ses_activity.png");
  STATUS_ICN_CFG_D_NEW(25, L"ses_suspended.png");
  STATUS_ICN_CFG_D_NEW(26, L"ir_attached.png");
  STATUS_ICN_CFG_D_NEW(27, L"stopwatch.png");
...
int merge_from_v2_14(v2_15_config_t *newcfg, void *oldcfg, int oldcfgsize)
{
  int result = -1;
  if(oldcfgsize == sizeof(v2_14_config_t))
  {
    _merge_from_v2_14(newcfg, (v2_14_config_t *)oldcfg);
    result = 0;
  }
  else
  {
    char *buf;
    if ((buf=new char[sizeof(v2_14_config_t)]))
    {
      if(merge_from_v2_13((v2_14_config_t *)buf, oldcfg, oldcfgsize) == 0)
      {
        _merge_from_v2_14(newcfg, (v2_14_config_t *)buf);
        result = 0;
      }
    }
    delete buf;
