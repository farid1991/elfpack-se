...
id3_latin1_t *id3_ucs4_latin1duplicate(id3_ucs4_t const *ucs4)
{
  ...
  latin1 = (id3_latin1_t *)malloc(id3_ucs4_latin1size(ucs4) * sizeof(*latin1));
  if (latin1)
...
id3_utf16_t *id3_ucs4_utf16duplicate(id3_ucs4_t const *ucs4)
{
  ...
  utf16 = (id3_utf16_t *)malloc(id3_ucs4_utf16size(ucs4) * sizeof(*utf16));
  if (utf16)
...
id3_utf8_t *id3_ucs4_utf8duplicate(id3_ucs4_t const *ucs4)
{
  ...
  utf8 = (id3_utf8_t *)malloc(id3_ucs4_utf8size(ucs4) * sizeof(*utf8));
  if (utf8)
...
id3_ucs4_t *id3_ucs4_duplicate(id3_ucs4_t const *src)
{
  ...
  ucs4 = (id3_ucs4_t *)malloc(id3_ucs4_size(src) * sizeof(*ucs4));
  if (ucs4)
