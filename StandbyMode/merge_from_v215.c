...
void _merge_from_v2_15(v2_16_config_t *newcfg, v2_15_config_t *oldcfg)
{
//Картинки ...
//Картинка 1
...
//Время 1...
  ...
  newcfg->cfg_seconds_highlight = oldcfg->cfg_highlight;
  ...
  newcfg->cfg_clock_highlight = oldcfg->cfg_highlight;
...
//Дата...
  ...
  newcfg->cfg_date_highlight = oldcfg->cfg_highlight;
...
//День...
  ...
  newcfg->cfg_day_highlight = oldcfg->cfg_highlight;
  ...
  newcfg->cfg_alarm_highlight = oldcfg->cfg_highlight;
...
//Heap...
  ...
  newcfg->cfg_heap_highlight = oldcfg->cfg_highlight;
...
//Емкость батареи...
  ...
  newcfg->cfg_batt_percent_highlight = oldcfg->cfg_highlight;
  newcfg->cfg_percent_offset_y = oldcfg->cfg_percent_offset_y;
  newcfg->cfg_batt_font = oldcfg->cfg_batt_font;
  newcfg->cfg_batt_highlight = oldcfg->cfg_highlight;
  ...
  newcfg->cfg_batt_bar_highlight = oldcfg->cfg_highlight;
...
//Ток заряда...
  ...
  newcfg->cfg_current_highlight = oldcfg->cfg_highlight;
...
//Температура батареи...
  ...
  newcfg->cfg_batt_temp_highlight = oldcfg->cfg_highlight;
...
//Температура телефона...
  ...
  newcfg->cfg_temp_highlight = oldcfg->cfg_highlight;
...
//Телефон...
  ...
  newcfg->cfg_phone_highlight = oldcfg->cfg_highlight;
  ...
  newcfg->cfg_phone_bar_highlight = oldcfg->cfg_highlight;
...
//Карта памяти...
  ...
  newcfg->cfg_card_highlight = oldcfg->cfg_highlight;
  ...
  newcfg->cfg_card_bar_highlight = oldcfg->cfg_highlight;
...
//Частота станции...
  ...
  newcfg->cfg_fm_highlight = oldcfg->cfg_highlight;
...
//Режим стерео...
  ...
  newcfg->cfg_fm_mode_highlight = oldcfg->cfg_highlight;
...
//RDS данные...
  ...
  newcfg->cfg_fm_rdsdata_highlight = oldcfg->cfg_highlight;
...
//Название песни
  ...
  newcfg->cfg_player_title_highlight = oldcfg->cfg_highlight;
  ...
  if(oldcfg->cfg_player_title_align == RIGHT)
  {
    newcfg->cfg_player_title_rc.x2 = oldcfg->cfg_player_title_x;
    newcfg->cfg_player_title_rc.y1 = oldcfg->cfg_player_title_y;
    newcfg->cfg_player_title_rc.x1 = 1;
  }
  else
  {
    newcfg->cfg_player_title_rc.x1 = oldcfg->cfg_player_title_x;
    newcfg->cfg_player_title_rc.y1 = oldcfg->cfg_player_title_y;
    newcfg->cfg_player_title_rc.x2 = DisplayWidth;
  }
  newcfg->cfg_player_title_rc.y2 = DisplayHeight;
...
//Альбом
  ...
  newcfg->cfg_player_album_highlight = oldcfg->cfg_highlight;
  ...
  if(oldcfg->cfg_player_album_align == RIGHT)
  {
    newcfg->cfg_player_album_rc.x2 = oldcfg->cfg_player_album_x;
    newcfg->cfg_player_album_rc.y1 = oldcfg->cfg_player_album_y;
    newcfg->cfg_player_album_rc.x1 = 1;
  }
  else
  {
    newcfg->cfg_player_album_rc.x1 = oldcfg->cfg_player_album_x;
    newcfg->cfg_player_album_rc.y1 = oldcfg->cfg_player_album_y;
    newcfg->cfg_player_album_rc.x2 = DisplayWidth;
  }
  newcfg->cfg_player_album_rc.y2 = DisplayHeight;
...
//Исполнитель
  ...
  newcfg->cfg_player_artist_highlight = oldcfg->cfg_highlight;
  ...
  if(oldcfg->cfg_player_artist_align == RIGHT)
  {
    newcfg->cfg_player_artist_rc.x2 = oldcfg->cfg_player_artist_x;
    newcfg->cfg_player_artist_rc.y1 = oldcfg->cfg_player_artist_y;
    newcfg->cfg_player_artist_rc.x1 = 1;
  }
  else
  {
    newcfg->cfg_player_artist_rc.x1 = oldcfg->cfg_player_artist_x;
    newcfg->cfg_player_artist_rc.y1 = oldcfg->cfg_player_artist_y;
    newcfg->cfg_player_artist_rc.x2 = DisplayWidth;
  }
  newcfg->cfg_player_artist_rc.y2 = DisplayHeight;
...
//Год
  ...
  newcfg->cfg_player_year_highlight = oldcfg->cfg_highlight;
  ...
  if(oldcfg->cfg_player_year_align == RIGHT)
  {
    newcfg->cfg_player_year_rc.x2 = oldcfg->cfg_player_year_x;
    newcfg->cfg_player_year_rc.y1 = oldcfg->cfg_player_year_y;
    newcfg->cfg_player_year_rc.x1 = 1;
  }
  else
  {
    newcfg->cfg_player_year_rc.x1 = oldcfg->cfg_player_year_x;
    newcfg->cfg_player_year_rc.y1 = oldcfg->cfg_player_year_y;
    newcfg->cfg_player_year_rc.x2 = DisplayWidth;
  }
  newcfg->cfg_player_year_rc.y2 = DisplayHeight;
...
//Жанр
  ...
  newcfg->cfg_player_genre_highlight = oldcfg->cfg_highlight;
  ...
  if(oldcfg->cfg_player_genre_align == RIGHT)
  {
    newcfg->cfg_player_genre_rc.x2 = oldcfg->cfg_player_genre_x;
    newcfg->cfg_player_genre_rc.y1 = oldcfg->cfg_player_genre_y;
    newcfg->cfg_player_genre_rc.x1 = 1;
  }
  else
  {
    newcfg->cfg_player_genre_rc.x1 = oldcfg->cfg_player_genre_x;
    newcfg->cfg_player_genre_rc.y1 = oldcfg->cfg_player_genre_y;
    newcfg->cfg_player_genre_rc.x2 = DisplayWidth;
  }
  newcfg->cfg_player_genre_rc.y2 = DisplayHeight;
...
//Частота дискретизации
  ...
  newcfg->cfg_player_frequency_highlight = oldcfg->cfg_highlight;
  ...
  if(oldcfg->cfg_player_frequency_align == RIGHT)
  {
    newcfg->cfg_player_frequency_rc.x2 = oldcfg->cfg_player_frequency_x;
    newcfg->cfg_player_frequency_rc.y1 = oldcfg->cfg_player_frequency_y;
    newcfg->cfg_player_frequency_rc.x1 = 1;
  }
  else
  {
    newcfg->cfg_player_frequency_rc.x1 = oldcfg->cfg_player_frequency_x;
    newcfg->cfg_player_frequency_rc.y1 = oldcfg->cfg_player_frequency_y;
    newcfg->cfg_player_frequency_rc.x2 = DisplayWidth;
  }
  newcfg->cfg_player_frequency_rc.y2 = DisplayHeight;
...
//Битрейт
  ...
  newcfg->cfg_player_bitrate_highlight = oldcfg->cfg_highlight;
  ...
  if(oldcfg->cfg_player_bitrate_align == RIGHT)
  {
    newcfg->cfg_player_bitrate_rc.x2 = oldcfg->cfg_player_bitrate_x;
    newcfg->cfg_player_bitrate_rc.y1 = oldcfg->cfg_player_bitrate_y;
    newcfg->cfg_player_bitrate_rc.x1 = 1;
  }
  else
  {
    newcfg->cfg_player_bitrate_rc.x1 = oldcfg->cfg_player_bitrate_x;
    newcfg->cfg_player_bitrate_rc.y1 = oldcfg->cfg_player_bitrate_y;
    newcfg->cfg_player_bitrate_rc.x2 = DisplayWidth;
  }
  newcfg->cfg_player_bitrate_rc.y2 = DisplayHeight;
...
//Каналы
  ...
  newcfg->cfg_player_channels_highlight = oldcfg->cfg_highlight;
  ...
  if(oldcfg->cfg_player_channels_align == RIGHT)
  {
    newcfg->cfg_player_channels_rc.x2 = oldcfg->cfg_player_channels_x;
    newcfg->cfg_player_channels_rc.y1 = oldcfg->cfg_player_channels_y;
    newcfg->cfg_player_channels_rc.x1 = 1;
  }
  else
  {
    newcfg->cfg_player_channels_rc.x1 = oldcfg->cfg_player_channels_x;
    newcfg->cfg_player_channels_rc.y1 = oldcfg->cfg_player_channels_y;
    newcfg->cfg_player_channels_rc.x2 = DisplayWidth;
  }
  newcfg->cfg_player_channels_rc.y2 = DisplayHeight;
...
//Длительность...
  ...
  newcfg->cfg_player_fulltime_highlight = oldcfg->cfg_highlight;
  ...
  if(oldcfg->cfg_player_fulltime_align == RIGHT)
  {
    newcfg->cfg_player_fulltime_rc.x2 = oldcfg->cfg_player_fulltime_x;
    newcfg->cfg_player_fulltime_rc.y1 = oldcfg->cfg_player_fulltime_y;
    newcfg->cfg_player_fulltime_rc.x1 = 1;
  }
  else
  {
    newcfg->cfg_player_fulltime_rc.x1 = oldcfg->cfg_player_fulltime_x;
    newcfg->cfg_player_fulltime_rc.y1 = oldcfg->cfg_player_fulltime_y;
    newcfg->cfg_player_fulltime_rc.x2 = DisplayWidth;
  }
  newcfg->cfg_player_fulltime_rc.y2 = DisplayHeight;
...
//Текущее/оставшееся время...
  ...
  newcfg->cfg_player_curtime_highlight = oldcfg->cfg_highlight;
  ...
  if(oldcfg->cfg_player_curtime_align == RIGHT)
  {
    newcfg->cfg_player_curtime_rc.x2 = oldcfg->cfg_player_curtime_x;
    newcfg->cfg_player_curtime_rc.y1 = oldcfg->cfg_player_curtime_y;
    newcfg->cfg_player_curtime_rc.x1 = 1;
  }
  else
  {
    newcfg->cfg_player_curtime_rc.x1 = oldcfg->cfg_player_curtime_x;
    newcfg->cfg_player_curtime_rc.y1 = oldcfg->cfg_player_curtime_y;
    newcfg->cfg_player_curtime_rc.x2 = DisplayWidth;
  }
  newcfg->cfg_player_curtime_rc.y2 = DisplayHeight;
...
//Полоска...
  ...
  newcfg->cfg_player_timebar_highlight = oldcfg->cfg_highlight;
...
//Иконки статуса...
  ...
  newcfg->cfg_status_allowedcallers_show = 1;
  newcfg->cfg_status_ressignment_show = 0;
...
#define STATUS_ICN_CFG_D_NEW(num, file) \
  ...
  STATUS_ICN_CFG_D_NEW(28, L"callers_from_list.png");
  STATUS_ICN_CFG_D_NEW(29, L"none_callers.png");
  STATUS_ICN_CFG_D_NEW(30, L"ressignment.png");

  wstrcpy(newcfg->cfg_ressignment_addr, L"0x");
...
//Сеть ...
  ...
  newcfg->cfg_network_rssi_highlight = oldcfg->cfg_highlight;
  ...
  newcfg->cfg_network_rssi_percent_highlight = oldcfg->cfg_highlight;
...
//Приложения...
  ...
  newcfg->cfg_app_book_highlight = oldcfg->cfg_highlight;
  ...
  newcfg->cfg_app_elf_highlight = oldcfg->cfg_highlight;
  ...
  newcfg->cfg_app_java_highlight = oldcfg->cfg_highlight;
...
//Сообщение 1
  ...
  newcfg->cfg_msg1_highlight = oldcfg->cfg_highlight;
...
//Сообщение 2
  ...
  newcfg->cfg_msg2_highlight = oldcfg->cfg_highlight;
...
//Сообщение 3
  ...
  newcfg->cfg_msg3_highlight = oldcfg->cfg_highlight;
...
//Сообщение 4
  ...
  newcfg->cfg_msg4_highlight = oldcfg->cfg_highlight;
...
//Сообщение 5
  ...
  newcfg->cfg_msg5_highlight = oldcfg->cfg_highlight;
...
//Сообщение 6
  ...
  newcfg->cfg_msg6_highlight = oldcfg->cfg_highlight;
...
int merge_from_v2_15(v2_16_config_t *newcfg, void *oldcfg, int oldcfgsize)
{
  int result = -1;
  if(oldcfgsize == sizeof(v2_15_config_t))
  {
    _merge_from_v2_15(newcfg, (v2_15_config_t *)oldcfg);
    result = 0;
  }
  else
  {
    char *buf;
    if ((buf=new char[sizeof(v2_15_config_t)]))
    {
      if(merge_from_v2_14((v2_15_config_t *)buf, oldcfg, oldcfgsize) == 0)
      {
        _merge_from_v2_15(newcfg, (v2_15_config_t *)buf);
        result = 0;
      }
    }
    delete buf;
