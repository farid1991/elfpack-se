...
void _merge_from_v2_8(v2_9_config_t *newcfg, v2_8_config_t *oldcfg)
{
//Картинки ...
//Картинка 1
  ...
  strcpy(newcfg->cfg_file1, oldcfg->cfg_file1);
//Картинка 2
  ...
  strcpy(newcfg->cfg_file2, oldcfg->cfg_file2);
//Картинка 3
  ...
  strcpy(newcfg->cfg_file3, oldcfg->cfg_file3);
//Картинка 4
  ...
  strcpy(newcfg->cfg_file4, oldcfg->cfg_file4);
//Картинка 5
  ...
  strcpy(newcfg->cfg_file5, oldcfg->cfg_file5);
//Картинка 6
  ...
  strcpy(newcfg->cfg_file6, oldcfg->cfg_file6);
  newcfg->cfg_image6_slideshow = oldcfg->cfg_image6_slideshow;
  strcpy(newcfg->cfg_folder6, oldcfg->cfg_folder6);
...
//Емкость батареи...
  ...
  strcpy(newcfg->cfg_batt_0_file, oldcfg->cfg_batt_0_file);
  strcpy(newcfg->cfg_batt_5_file, oldcfg->cfg_batt_5_file);
  strcpy(newcfg->cfg_batt_15_file, oldcfg->cfg_batt_15_file);
  strcpy(newcfg->cfg_batt_25_file, oldcfg->cfg_batt_25_file);
  strcpy(newcfg->cfg_batt_35_file, oldcfg->cfg_batt_35_file);
  strcpy(newcfg->cfg_batt_45_file, oldcfg->cfg_batt_45_file);
  strcpy(newcfg->cfg_batt_55_file, oldcfg->cfg_batt_55_file);
  strcpy(newcfg->cfg_batt_65_file, oldcfg->cfg_batt_65_file);
  strcpy(newcfg->cfg_batt_75_file, oldcfg->cfg_batt_75_file);
  strcpy(newcfg->cfg_batt_85_file, oldcfg->cfg_batt_85_file);
  strcpy(newcfg->cfg_batt_100_file, oldcfg->cfg_batt_100_file);
...
//Индикация заряда...
  ...
  strcpy(newcfg->cfg_batt_charge_file, oldcfg->cfg_batt_charge_file);
//Температура батареи...
...
//Картинка...
  ...
  strcpy(newcfg->cfg_fm_file, oldcfg->cfg_fm_file);
//Плеер...
//Название песни
...
//Картинка
  ...
  strcpy(newcfg->cfg_player_file, oldcfg->cfg_player_file);
...
//Сеть...
  newcfg->cfg_network_rssi_not_show_if_player = 0;
  newcfg->cfg_network_not_show_if_player = oldcfg->cfg_network_not_show_if_player;
//Приложения...
  newcfg->cfg_app_not_show_if_player = 0;
//Свои сообщения...
...
//Сеть ...
  newcfg->cfg_network_rssi_show = 0;
  newcfg->cfg_network_rssi_dbm_show = 1;
  newcfg->cfg_network_rssi_font = 0;
  newcfg->cfg_network_rssi_color = 0xFF000000;
  newcfg->cfg_network_rssi_border = 0xFFFFFFFF;
  newcfg->cfg_network_rssi_align = 0;
  newcfg->cfg_network_rssi_x = 0;
  newcfg->cfg_network_rssi_y = 0;
  ...
  strcpy(newcfg->cfg_net_act_edge_0_file, oldcfg->cfg_net_act_edge_0_file);
  strcpy(newcfg->cfg_net_act_edge_1_file, oldcfg->cfg_net_act_edge_1_file);
  strcpy(newcfg->cfg_net_act_edge_2_file, oldcfg->cfg_net_act_edge_2_file);
  strcpy(newcfg->cfg_net_act_edge_3_file, oldcfg->cfg_net_act_edge_3_file);
  strcpy(newcfg->cfg_net_act_edge_4_file, oldcfg->cfg_net_act_edge_4_file);
  strcpy(newcfg->cfg_net_act_edge_5_file, oldcfg->cfg_net_act_edge_5_file);
  strcpy(newcfg->cfg_net_edge_0_file, oldcfg->cfg_net_edge_0_file);
  strcpy(newcfg->cfg_net_edge_1_file, oldcfg->cfg_net_edge_1_file);
  strcpy(newcfg->cfg_net_edge_2_file, oldcfg->cfg_net_edge_2_file);
  strcpy(newcfg->cfg_net_edge_3_file, oldcfg->cfg_net_edge_3_file);
  strcpy(newcfg->cfg_net_edge_4_file, oldcfg->cfg_net_edge_4_file);
  strcpy(newcfg->cfg_net_edge_5_file, oldcfg->cfg_net_edge_5_file);
  strcpy(newcfg->cfg_net_act_gprs_0_file, oldcfg->cfg_net_act_gprs_0_file);
  strcpy(newcfg->cfg_net_act_gprs_1_file, oldcfg->cfg_net_act_gprs_1_file);
  strcpy(newcfg->cfg_net_act_gprs_2_file, oldcfg->cfg_net_act_gprs_2_file);
  strcpy(newcfg->cfg_net_act_gprs_3_file, oldcfg->cfg_net_act_gprs_3_file);
  strcpy(newcfg->cfg_net_act_gprs_4_file, oldcfg->cfg_net_act_gprs_4_file);
  strcpy(newcfg->cfg_net_act_gprs_5_file, oldcfg->cfg_net_act_gprs_5_file);
  strcpy(newcfg->cfg_net_gprs_0_file, oldcfg->cfg_net_gprs_0_file);
  strcpy(newcfg->cfg_net_gprs_1_file, oldcfg->cfg_net_gprs_1_file);
  strcpy(newcfg->cfg_net_gprs_2_file, oldcfg->cfg_net_gprs_2_file);
  strcpy(newcfg->cfg_net_gprs_3_file, oldcfg->cfg_net_gprs_3_file);
  strcpy(newcfg->cfg_net_gprs_4_file, oldcfg->cfg_net_gprs_4_file);
  strcpy(newcfg->cfg_net_gprs_5_file, oldcfg->cfg_net_gprs_5_file);
  strcpy(newcfg->cfg_net_none_0_file, oldcfg->cfg_net_none_0_file);
  strcpy(newcfg->cfg_net_none_1_file, oldcfg->cfg_net_none_1_file);
  strcpy(newcfg->cfg_net_none_2_file, oldcfg->cfg_net_none_2_file);
  strcpy(newcfg->cfg_net_none_3_file, oldcfg->cfg_net_none_3_file);
  strcpy(newcfg->cfg_net_none_4_file, oldcfg->cfg_net_none_4_file);
  strcpy(newcfg->cfg_net_none_5_file, oldcfg->cfg_net_none_5_file);
  strcpy(newcfg->cfg_net_flight_file, oldcfg->cfg_net_flight_file);
  newcfg->cfg_refresh_network = oldcfg->cfg_refresh_network;

//Приложения...
  newcfg->cfg_app_show = 0;
  newcfg->cfg_app_row_max = 1;
  newcfg->cfg_app_column_max = 8;
  newcfg->cfg_app_fill_by_row = 1;
  newcfg->cfg_app_x = 0;
  newcfg->cfg_app_y = 0;
...
int merge_from_v2_8(v2_9_config_t *newcfg, void *oldcfg, int oldcfgsize)
{
  int result = -1;
  if(oldcfgsize == sizeof(v2_8_config_t))
  {
    _merge_from_v2_8(newcfg, (v2_8_config_t *)oldcfg);
    result = 0;
  }
  else
  {
    char *buf;
    if ((buf=new char[sizeof(v2_8_config_t)]))
    {
      if(merge_from_v2_7((v2_8_config_t *)buf, oldcfg, oldcfgsize) == 0)
      {
        _merge_from_v2_8(newcfg, (v2_8_config_t *)buf);
        result = 0;
      }
    }
    delete buf;
