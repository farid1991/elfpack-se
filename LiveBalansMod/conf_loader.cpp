...
void InitConfig(void)
{
  unsigned int cc;
  unsigned int nc;
  char *imsi="0123456789"; //GetIMSI();
  cc=GetCC_NCfromIMSI(imsi);
  nc=cc&0xFFFF;
  cc>>=16;
  snwprintf(config_name,MAXELEMS(config_name)-1,L"LiveBalanceMod_%02X-%02X%02X%02X%02X-%03X.bcfg",nc,imsi[5],imsi[6],imsi[7],imsi[8],cc);
