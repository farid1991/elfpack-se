...
extern const int NameBookAsSession;
extern const int StandbyOnTop;
extern const int FirstTab;
extern const char tab1_act[40];
extern const char tab1_inact[40];
extern const char tab2_act[40];
extern const char tab2_inact[40];
