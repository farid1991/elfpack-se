...
INT8 sprite_list_needs_recache;
UINT8 sprites_on_line [LAST_DISPLAYED_LINE + 1] [8];
UINT8 sprite_count_on_line [LAST_DISPLAYED_LINE + 1];
INT8 sprite_overflow_on_line [LAST_DISPLAYED_LINE + 1];
...
void ppu_render_sprite (int sprite, int line)
{
    int x, y, sub_x/*, sub_y*/;
...
void ppu_render_sprites (int line)
{
    int i/*, priority*/;
