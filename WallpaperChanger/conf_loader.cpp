...
{
  if(LoadConfigData(GetDir(DIR_ELFS_CONFIG|MEM_EXTERNAL),L"WallpaperChanger.bcfg")<0)
  {
    LoadConfigData(GetDir(DIR_ELFS_CONFIG|MEM_INTERNAL),L"WallpaperChanger.bcfg");
  }
}
