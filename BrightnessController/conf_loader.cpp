...
{
  CheckConfig ();
  if (LoadConfigData(GetDir(DIR_ELFS_CONFIG|MEM_EXTERNAL),L"BrightnessController.bcfg")<0)
  {
    LoadConfigData(GetDir(DIR_ELFS_CONFIG|MEM_INTERNAL),L"BrightnessController.bcfg");
  }
}
